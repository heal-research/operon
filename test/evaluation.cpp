...
namespace Operon::Test
{
    ...
    TEST_CASE("Constant optimization (autodiff)", "[implementation]")
    {
        ...
        auto x1 = Node(NodeType::Variable, x1Var.Hash); x1.Value = 0.001;
        auto x2 = Node(NodeType::Variable, x2Var.Hash); x2.Value = 0.001;
        auto x3 = Node(NodeType::Variable, x3Var.Hash); x3.Value = 0.001;
        auto x4 = Node(NodeType::Variable, x4Var.Hash); x4.Value = 0.001;
        auto x5 = Node(NodeType::Variable, x5Var.Hash); x5.Value = 0.001;
        auto x6 = Node(NodeType::Variable, x6Var.Hash); x6.Value = 0.001;
        auto x7 = Node(NodeType::Variable, x7Var.Hash); x7.Value = 0.001;
        auto x9 = Node(NodeType::Variable, x9Var.Hash); x9.Value = 0.001;
        auto x10 = Node(NodeType::Variable, x10Var.Hash); x10.Value = 0.001;

        auto add = Node(NodeType::Add);
        auto mul = Node(NodeType::Mul);

        auto poly10 = Tree { 
            x1, x2, mul, x3, x4, mul, add, 
            x5, x6, mul, add, 
            x1, x7, mul, x9, mul, add, 
            x3, x6, mul, x10, mul, add, 
        };
        poly10.UpdateNodes();
