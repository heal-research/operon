...
TEST_SUITE("[implementation]")
{
    ...
    TEST_CASE("Parser")
    {
        ...
        pset.SetConfig((PrimitiveSet::Arithmetic | NodeType::Exp | NodeType::Logabs | NodeType::Sin | NodeType::Cos | NodeType::Tan |  NodeType::Sqrtabs | NodeType::Cbrt) & ~NodeType::Variable);
        //pset.SetConfig(PrimitiveSet::Arithmetic & ~(NodeType::Div | NodeType::Variable));
        ...
        for (int i = 0; i < nTrees; ++i) {
            ...
            auto s3 = Operon::InfixFormatter::Format(parsedTrees[i], ds, 5);
