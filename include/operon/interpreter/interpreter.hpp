...
auto OPERON_EXPORT EvaluateTrees(std::vector<Operon::Tree> const& trees, Operon::Dataset const& dataset, Operon::Range range, Operon::Span<Operon::Scalar> result, size_t nthread) -> void;
} // namespace Operon
