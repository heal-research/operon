...
inline auto R2Score(InputIt1 begin1, InputIt1 end1, InputIt2 begin2) noexcept -> double
{
    ...
    auto ssr = univariate::accumulate<V1>(begin1, end1, begin2, [](auto a, auto b) { auto e = a - b; return e * e; }).sum;
    auto end2 = begin2;
    std::advance(end2, std::distance(begin1, end1));
    auto meanY = univariate::accumulate<V2>(begin2, end2).mean;
    auto sst = univariate::accumulate<V2>(begin2, end2, [&](auto v) { auto e = v - meanY; return e * e;} ).sum;
    if (sst < eps) {
