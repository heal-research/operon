...
{
    using V1 = typename std::iterator_traits<InputIt1>::value_type;
    return vstat::metrics::mean_absolute_error<V1, vstat::nan_policy::omit>(begin1, end1, begin2);
}
...
{
    using V1 = typename std::iterator_traits<InputIt1>::value_type;
    return vstat::metrics::mean_absolute_error<V1, vstat::nan_policy::omit>(begin1, end1, begin2, begin3);
}
