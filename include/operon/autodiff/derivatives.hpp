...
struct Derivative<Operon::NodeType::Abs> {
    inline auto operator()(auto const& /*nodes*/, auto const primal, auto trace, auto /*weights*/, auto i)
    {
        trace.col(i-1) = sign(primal.col(i-1));
    }
};
...
struct Derivative<Operon::NodeType::Log> {
    inline auto operator()(auto const& /*nodes*/, auto const primal, auto trace, auto /*weights*/, auto i)
    {
        trace.col(i-1) = inv(primal.col(i-1));
    }
};
...
struct Derivative<Operon::NodeType::Logabs> {
    inline auto operator()(auto const& /*nodes*/, auto const primal, auto trace, auto /*weights*/, auto i)
    {
        trace.col(i-1) = sign(primal.col(i-1)) / abs(primal.col(i-1));
    }
};
...
struct Derivative<Operon::NodeType::Log1p> {
    inline auto operator()(auto const& /*nodes*/, auto const primal, auto trace, auto /*weights*/, auto i)
    {
        trace.col(i-1) = inv(primal.col(i-1) + 1);
    }
};
...
struct Derivative<Operon::NodeType::Sin> {
    inline auto operator()(auto const& /*nodes*/, auto const primal, auto trace, auto /*weights*/, auto i)
    {
        trace.col(i-1) = cos(primal.col(i-1));
    }
};

template <>
struct Derivative<Operon::NodeType::Sinh> {
    inline auto operator()(auto const& /*nodes*/, auto const primal, auto trace, auto /*weights*/, auto i)
    {
        trace.col(i-1) = cosh(primal.col(i-1));
    }
};
...
struct Derivative<Operon::NodeType::Cos> {
    inline auto operator()(auto const& /*nodes*/, auto const primal, auto trace, auto /*weights*/, auto i)
    {
        trace.col(i-1) = -sin(primal.col(i-1));
    }
};

template <>
struct Derivative<Operon::NodeType::Cosh> {
    inline auto operator()(auto const& /*nodes*/, auto const primal, auto trace, auto /*weights*/, auto i)
    {
        trace.col(i-1) = sinh(primal.col(i-1));
    }
};
...
struct Derivative<Operon::NodeType::Tan> {
    inline auto operator()(auto const& /*nodes*/, auto const primal, auto trace, auto /*weights*/, auto i)
    {
        trace.col(i-1) = 1 + square(tan(primal.col(i-1)));
    }
};
...
struct Derivative<Operon::NodeType::Tanh> {
    inline auto operator()(auto const& /*nodes*/, auto const primal, auto trace, auto /*weights*/, auto i)
    {
        trace.col(i-1) = 1 - square(tanh(primal.col(i-1)));
    }
};
...
struct Derivative<Operon::NodeType::Asin> {
    inline auto operator()(auto const& /*nodes*/, auto const primal, auto trace, auto /*weights*/, auto i)
    {
        trace.col(i-1) = inv(sqrt(1 - square(primal.col(i-1))));
    }
};
...
struct Derivative<Operon::NodeType::Atan> {
    inline auto operator()(auto const& /*nodes*/, auto const primal, auto trace, auto /*weights*/, auto i)
    {
        trace.col(i-1) = inv(1 + square(primal.col(i-1)));
    }
};
...
struct Derivative<Operon::NodeType::Sqrt> {
    inline auto operator()(auto const& /*nodes*/, auto const primal, auto trace, auto weights, auto i)
    {
        trace.col(i-1) = weights[i] * inv(2 * primal.col(i));
    }
};
...
struct Derivative<Operon::NodeType::Sqrtabs> {
    inline auto operator()(auto const& /*nodes*/, auto const primal, auto trace, auto weights, auto i)
    {
        trace.col(i-1) = weights[i] * sign(primal.col(i-1)) / (2 * primal.col(i));
    }
};
...
struct Derivative<Operon::NodeType::Cbrt> {
    inline auto operator()(auto const& /*nodes*/, auto const primal, auto trace, auto weights, auto i)
    {
        trace.col(i-1) = inv(3 * square(primal.col(i) / weights[i]));
    }
};
} // namespace Operon::Autodiff
