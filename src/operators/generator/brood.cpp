...
#include "operators/generator/brood.hpp"

namespace Operon {
    std::optional<Individual> BroodOffspringGenerator::operator()(Operon::RandomGenerator& random, double pCrossover, double pMutation, Operon::Span<Operon::Scalar> buf) const
    {
