#{ gcc10Stdenv, lib, darwin, fetchFromGitHub, tbb, gtk2, glfw, pkgconfig, freetype, Carbon, AppKit, capstone }:
...
gcc10Stdenv.mkDerivation rec {
  ...
  buildInputs = [ glfw capstone ]
    ++ lib.optionals gcc10Stdenv.isDarwin [ Carbon AppKit freetype ]
    ++ lib.optionals gcc10Stdenv.isLinux [ gtk2 tbb ];

  NIX_CFLAGS_COMPILE = [ ]
    ++ lib.optional gcc10Stdenv.isLinux "-ltbb"
    ++ lib.optional gcc10Stdenv.cc.isClang "-faligned-allocation";
