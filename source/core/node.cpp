...
namespace Operon {
    static const Operon::Map<NodeType, pair<string, string>> NodeDesc = {
        ...
        { NodeType::Powabs,          std::make_pair("powabs", "raise to power f(a,b) = abs(a)^b" ) },
        ...
        { NodeType::Inv,             std::make_pair("inv", "inverse f(a) = a^-1 = 1/a" ) },
        { NodeType::Dynamic,         std::make_pair("dyn", "user-defined function" ) },
        { NodeType::Constant,        std::make_pair("constant", "a constant value" ) },
        { NodeType::VarWithoutCoeff, std::make_pair("variable_without_coeff", "a dataset input without weight" ) },
